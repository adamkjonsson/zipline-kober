...
| [`REPETITION-PHASE-PLAN.md`](REPETITION-PHASE-PLAN.md) | A way for a spec to ask a question about a repeated field, so HTTP can choose its own body framing instead of assuming one. | **In progress** — Q1–Q6 settled; both implementations agree on the whole corpus; Stages 6–8 open. |
